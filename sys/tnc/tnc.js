...
tinymce.init({
    ...
    setup: function (editor) {
        ...
        editor.on('BeforeSetContent', function (event) {
            ...
            .replace(/<includecontent :init-collapse="isClaimed" :url="gv.domains.content \+ '\/templates\/promotions\/Japan\/202505\/en-jp_JPAFFSNSPROMO_0525_how-use-bet.html'">\s*<\/includecontent>/g, '<h5 id="en-jp" class="non-editable" style="width: full; text-align: left; padding: 12px; background-color: #f5f5f5; border-left: 5px solid #5ba7ff;">How to use Sportbook Free Bet</h5><br>')
            .replace(/<includecontent :init-collapse="isClaimed" :url="gv.domains.content \+ '\/templates\/promotions\/Japan\/202505\/ja-jp_JPAFFSNSPROMO_0525_how-use-bet.html'">\s*<\/includecontent>/g, '<h5 id="ja-jp" class="non-editable" style="width: full; text-align: left; padding: 12px; background-color: #f5f5f5; border-left: 5px solid #5ba7ff;">スポーツブックのフリーベットの使い方</h5><br>')
            .replace(/<includecontent :init-collapse="isClaimed" :url="gv.domains.content \+ '\/templates\/promotions\/Japan\/202505\/en-jp_JPAFFSNSPROMO_0525_whre-to-find-your-free-spin.html'">\s*<\/includecontent>/g, '<h5 id="en-jp" class="non-editable" style="width: full; text-align: left; padding: 12px; background-color: #f5f5f5; border-left: 5px solid #5ba7ff;">Where to find your Free Spins</h5><br>')
            .replace(/<includecontent :init-collapse="isClaimed" :url="gv.domains.content \+ '\/templates\/promotions\/Japan\/202505\/ja-jp_JPAFFSNSPROMO_0525_whre-to-find-your-free-spin.html'">\s*<\/includecontent>/g, '<h5 id="ja-jp" class="non-editable" style="width: full; text-align: left; padding: 12px; background-color: #f5f5f5; border-left: 5px solid #5ba7ff;">フリースピンはここで確認</h5><br>')
                    ...
                    menu: [
                        {
                            ...
                            onclick: function() {
                            editor.insertContent('<h5 id="en-jp" class="non-editable" style="width: full; text-align: left; padding: 12px; background-color: #f5f5f5; border-left: 5px solid #5ba7ff;">Where to find your Sportbook Free Bet</h5><br>');  // Insert content on selection
                            }
                        },
                        {
                            text: '[JA-JP] スポーツ専用フリーベットはここで確認',
                            onclick: function() {
                            editor.insertContent('<h5 id="ja-jp" class="non-editable" style="width: full; text-align: left; padding: 12px; background-color: #f5f5f5; border-left: 5px solid #5ba7ff;">スポーツ専用フリーベットはここで確認</h5><br>');  // Insert content on selection
                            }
                        },
                        {
                            text: '[EN-JP] How to use Sportbook Free Bet',
                            onclick: function() {
                            editor.insertContent('<h5 id="en-jp" class="non-editable" style="width: full; text-align: left; padding: 12px; background-color: #f5f5f5; border-left: 5px solid #5ba7ff;">How to use Sportbook Free Bet</h5><br>');  // Insert content on selection
                            }
                        },
                        {
                            text: '[JA-JP] スポーツブックのフリーベットの使い方',
                            onclick: function() {
                            editor.insertContent('<h5 id="ja-jp" class="non-editable" style="width: full; text-align: left; padding: 12px; background-color: #f5f5f5; border-left: 5px solid #5ba7ff;">スポーツブックのフリーベットの使い方</h5><br>');  // Insert content on selection
                            }
                        },
                        {
                            text: '[EN-JP] Where to find you Free Spins',
                            onclick: function() {
                            editor.insertContent('<h5 id="en-jp" class="non-editable" style="width: full; text-align: left; padding: 12px; background-color: #f5f5f5; border-left: 5px solid #5ba7ff;">Where to find your Free Spins</h5><br>');  // Insert content on selection
                            }
                        },
                        {
                            text: '[JA-JP] フリースピンはここで確認',
                            onclick: function() {
                            editor.insertContent('<h5 id="ja-jp" class="non-editable" style="width: full; text-align: left; padding: 12px; background-color: #f5f5f5; border-left: 5px solid #5ba7ff;">フリースピンはここで確認</h5><br>');  // Insert content on selection
                            }
                        },
                    ]
                },
...
document.getElementById('download').addEventListener('click', () => {
    if (document.getElementById('import-check').checked === false) {
        ...
        //Sportsbook Free Bet Component
            ...
            .replaceAll('<h5 id="en-jp" class="non-editable" style="width: full; text-align: left; padding: 12px; background-color: #f5f5f5; border-left: 5px solid #5ba7ff;">How to use Sportbook Free Bet</h5>', '<IncludeContent :init-collapse="isClaimed" :url="gv.domains.content + \'/templates/promotions/Japan/202505/en-jp_JPAFFSNSPROMO_0525_how-use-bet.html\'" /></IncludeContent>')
            .replaceAll('<h5 id="ja-jp" class="non-editable" style="width: full; text-align: left; padding: 12px; background-color: #f5f5f5; border-left: 5px solid #5ba7ff;">スポーツブックのフリーベットの使い方</h5>', '<IncludeContent :init-collapse="isClaimed" :url="gv.domains.content + \'/templates/promotions/Japan/202505/ja-jp_JPAFFSNSPROMO_0525_how-use-bet.html\'" /></IncludeContent>')
            .replaceAll('<h5 id="en-jp" class="non-editable" style="width: full; text-align: left; padding: 12px; background-color: #f5f5f5; border-left: 5px solid #5ba7ff;">Where to find your Free Spins</h5>', '<IncludeContent :init-collapse="isClaimed" :url="gv.domains.content + \'/templates/promotions/Japan/202505/en-jp_JPAFFSNSPROMO_0525_whre-to-find-your-free-spin.html\'" /></IncludeContent>')
            .replaceAll('<h5 id="ja-jp" class="non-editable" style="width: full; text-align: left; padding: 12px; background-color: #f5f5f5; border-left: 5px solid #5ba7ff;">フリースピンはここで確認</h5>', '<IncludeContent :init-collapse="isClaimed" :url="gv.domains.content + \'/templates/promotions/Japan/202505/ja-jp_JPAFFSNSPROMO_0525_whre-to-find-your-free-spin.html\'" /></IncludeContent>')
