...
let qualifyGames1 = `<div class="flex flex-col gap-y-2">
                            <div class="bg-neutral-900 text-white font-semibold rounded-[4px] px-2 text-xs border border-neutral-500 w-fit">
                                <select name="" id="provider1" class="bg-transparent border-none outline-none w-44 h-10 py-2 cursor-pointer">
...
let qualifyGames2 = `<div class="flex flex-col gap-y-2">
                     ...
                     <div class="flex flex-col gap-y-2">
                            <div class="bg-neutral-900 text-white font-semibold rounded-[4px] px-2 text-xs border border-neutral-500 w-fit">
                                <select name="" id="provider2" class="bg-transparent border-none outline-none w-44 h-10 py-2 cursor-pointer">
                                    <option value="#">Select Provider</option>
                                    <option value="Netent">Netent</option>
                                    <option value="Big Time Gaming">Big Time Gaming</option>
                                    <option value="Nolimit City">NoLimit City</option>
...
let qualifyGames3 = `<div class="flex flex-col gap-y-2">
                     ...
                     <div class="flex flex-col gap-y-2">
                            <div class="bg-neutral-900 text-white font-semibold rounded-[4px] px-2 text-xs border border-neutral-500 w-fit">
                                <select name="" id="provider3" class="bg-transparent border-none outline-none w-44 h-10 py-2 cursor-pointer">
                                    <option value="#">Select Provider</option>
                                    <option value="Netent">Netent</option>
                                    <option value="Big Time Gaming">Big Time Gaming</option>
                                    <option value="Nolimit City">NoLimit City</option>
...
let qualifyGames4 = `<div class="flex flex-col gap-y-2">
                     ...
                     <div class="flex flex-col gap-y-2">
                            <div class="bg-neutral-900 text-white font-semibold rounded-[4px] px-2 text-xs border border-neutral-500 w-fit">
                                <select name="" id="provider4" class="bg-transparent border-none outline-none w-44 h-10 py-2 cursor-pointer">
                                    <option value="#">Select Provider</option>
                                    <option value="Netent">Netent</option>
                                    <option value="Big Time Gaming">Big Time Gaming</option>
                                    <option value="Nolimit City">NoLimit City</option>
